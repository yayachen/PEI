...
#            beats = []
            #Use Midicsv to convert MIDI into csv
            print(['Midicsv', args.inputPath + '/' + file, 'temp.csv'])
 #           subprocess.call(['open', os.getcwd()+'/ABC.txt'])
            subprocess.call([os.getcwd()+'/Midicsv.exe', args.inputPath + '/' + file, 'temp.csv'], shell=True)
            subprocess.call(['open', os.getcwd()+'/catAndDog.exe'], shell=True)
   #         subprocess.call([os.getcwd()+'/catAndDog.exe'])
